...
// #define USE_SH1106
#define BUTTON_PRE_MESH_PACKET 38    // 定义GPIO40引脚，查看上一条消息
#define BUTTON_NEX_MESH_PACKET 40    // 定义GPIO38引脚，查看下一条消息
#define BUTTON_PRE_CHANNEL_PACKET 39 // 定义GPIO39引脚，查看上一个channel
