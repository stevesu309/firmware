...
// #if defined(TTGO_T_ECHO) || defined(CANARYONE) || defined(MESHLINK) || defined(ELECROW_ThinkNode_M1) || defined(RED_BANK_S3)
    ...
    */
    ...
    if (moduleConfig.serial.override_console_serial_port || (moduleConfig.serial.rxd && moduleConfig.serial.txd))
    {
        if (firstTime)
        {
            ...
            // #elif !defined(TTGO_T_ECHO) && !defined(CANARYONE) && !defined(MESHLINK) && !defined(ELECROW_ThinkNode_M1) && !defined(RED_BANK_S3)
            if (moduleConfig.serial.rxd && moduleConfig.serial.txd)
            {
#ifdef ARCH_RP2040
...
//     !defined(ELECROW_ThinkNode_M1) && !defined(RED_BANK_S3)
#if !defined(TTGO_T_ECHO) && !defined(CANARYONE) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(MESHLINK) && \
