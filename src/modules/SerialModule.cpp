...
SerialModuleRadio *serialModuleRadio;
    ...
    defined(ELECROW_ThinkNode_M5) || defined(REDCOAST_SOLO_915)
...
int32_t SerialModule::runOnce()
{
    ...
    */
    ...
    !defined(ELECROW_ThinkNode_M1) && !defined(ELECROW_ThinkNode_M5) && !defined(REDCOAST_SOLO_915)
            if (moduleConfig.serial.rxd && moduleConfig.serial.txd)
            {
#ifdef ARCH_RP2040
...
void SerialModule::processWXSerial()
{
    ...
    !defined(MESHLINK) && !defined(ELECROW_ThinkNode_M1) && !defined(ELECROW_ThinkNode_M5) && !defined(REDCOAST_SOLO_915)
