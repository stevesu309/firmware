                                        ...
                                        const char *mode)
    {
        ...
        else
        {
            ...
            if (gpsFormat != meshtastic_DeviceUIConfig_GpsCoordinateFormat_DMS)
            {
                ...
                if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_DEC)
                { // Decimal Degrees
                ...
                else if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_UTM)
                ...
                else if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_MGRS)
                ...
                else if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_OLC)
                { // Open Location Code
                    geoCoord.getOLCCode(coordinateLine_1);
                    coordinateLine_2[0] = '\0';
                }
                else if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_OSGR)
                { // Ordnance Survey Grid Reference
                    if (geoCoord.getOSGRE100k() == 'I' || geoCoord.getOSGRN100k() == 'I')
                    { // OSGR is only valid around the UK region
                ...
                else if (gpsFormat == meshtastic_DeviceUIConfig_GpsCoordinateFormat_MLS)
