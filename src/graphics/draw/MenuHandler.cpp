...
namespace graphics
{
    ...
    namespace
    {
                                                       ...
                                                       std::array<const char *, N> &labels, Callback &&onSelection)
        {
            ...
            bannerOptions.bannerCallback = [optionsPtr, callback](int selected) -> void
            { callback(optionsPtr[selected], selected); };
...
void menuHandler::loraMenu()
{
    ...
    {
        auto encodeChannelId = [](int ch) -> int
        { return 100 + ch; };
        auto isChannelSel = [](int id) -> bool
...
void menuHandler::animationMenu()
{
    ...
    void menuHandler::GPSUpdateIntervalMenu()
    {
        ...
        else if (config.position.gps_update_interval == 2147483647)
        { // At Boot Only
